...
public class CodeImpUndoManager implements IUndoManager {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#addListener(org.eclipse.ltk.core.refactoring.IUndoManagerListener)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#removeListener(org.eclipse.ltk.core.refactoring.IUndoManagerListener)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#aboutToPerformChange(org.eclipse.ltk.core.refactoring.Change)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#changePerformed(org.eclipse.ltk.core.refactoring.Change)
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#changePerformed(org.eclipse.ltk.core.refactoring.Change, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#addUndo(java.lang.String, org.eclipse.ltk.core.refactoring.Change)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#performUndo(org.eclipse.ltk.core.refactoring.IValidationCheckResultQuery, org.eclipse.core.runtime.IProgressMonitor)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ltk.core.refactoring.IUndoManager#performRedo(org.eclipse.ltk.core.refactoring.IValidationCheckResultQuery, org.eclipse.core.runtime.IProgressMonitor)
	 */
	@Override
		...
		for (int i= 0; i < listeners.length; i++) {
			...
			SafeRunner.run(new ISafeRunnable() {
				public void run() throws Exception {
					listener.aboutToPerformChange(CodeImpUndoManager.this, change);
				}
